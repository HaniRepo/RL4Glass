# -*- coding: utf-8 -*-
"""CtrlParametersCooling.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_xpKJlXEjZO4Nm-rdrwjUXCdxnWBxeiS
"""
...
# ====== Experiments Starting from Steady State with Cooling Variations ======
with open(file_path_experiments_cooling, mode='w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow([
    ...
    variations = [
        ...
        {"label": "+10% Cooling", "variation": COOLING_VARIATION},
        {"label": "-10% Cooling", "variation": -COOLING_VARIATION},
    ]
    ...
    for variation in variations:
        ...
        cooling_deg = COOLING_NOMINAL_DEG * (1 + variation["variation"])
...
print("\nFinal Results (After Steady State with Cooling Variations):")
...
plt.title("Gob Temperatures for Different Cooling Scenarios")
plt.legend()
plt.grid(True)
plt.show()
...
plt.title("Mold Temperatures for Different Cooling Scenarios")
plt.legend()
plt.grid(True)
plt.show()

files.download(file_path_experiments_cooling)